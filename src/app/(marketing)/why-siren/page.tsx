        ...
        <div className="relative mx-auto max-w-3xl px-4 py-16 sm:px-6 md:py-24">
          <RevealOnScroll>
            ...
            <p className="mt-6 max-w-2xl text-lg text-ink-dim sm:text-xl">
              The sideline tool that tracks where every kid has played, not just
        ...
        <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 md:py-20">
          <RevealOnScroll>
            ...
            <div className="mt-6 space-y-5 text-lg leading-relaxed text-ink-dim">
              <p>
                You&apos;re coaching the U10s. Marcus has been pinned in the
                same spot all quarter. Chloe just rolled in late. Your shooter
                (or full-forward, depending which sport you&apos;re reading this
                on) needs a spell. Jasper&apos;s dad is yelling from the
                boundary that his son hasn&apos;t had a go in the middle all
                game.
              </p>
              <p>
                You&apos;ve got a whistle in one hand, a clipboard in the other,
                and three minutes until the next break.
              </p>
        ...
        <div className="mx-auto max-w-6xl px-4 py-20 sm:px-6 md:py-28">
          <div className="grid grid-cols-1 items-start gap-12 lg:grid-cols-2 lg:gap-16">
            <RevealOnScroll>
              ...
              <div className="mt-6 space-y-5 text-base leading-relaxed text-ink-dim sm:text-lg">
                <p>
                  A generic sports app can count minutes. But in junior sport,
                  fair isn&apos;t about how long a kid&apos;s been on. It&apos;s
                  about whether they&apos;ve had a crack at every part of the
                  game.
                </p>
                <p>
                  Siren tracks time per position area: attack, centre, defence,
                  and bench. Football coaches see forward, centre, back,
                  interchange. Netball coaches see attack third, centre third,
                  defence third, bench. When the rotation suggester runs, it
                  doesn&apos;t just look at who&apos;s played the least — it
                  looks at who&apos;s missed out on where. The kid who spent the
                  whole first quarter at full-back (or stuck at goal keeper)
                  gets their run up front before the final siren.
                </p>
          ...
          <RevealOnScroll>
            <p className="mx-auto mt-12 max-w-3xl rounded-md border border-brand-200/60 bg-brand-50/60 px-5 py-4 text-sm leading-relaxed text-ink-dim sm:text-base">
              Following your league&apos;s junior rotation policy (rotate every
              quarter, several positions, 50&ndash;75&#37; minimum game time)
              turns out to be a nice side effect. The point is that every kid
              leaves the ground feeling like they got a go.
            </p>
          </RevealOnScroll>
        </div>
      </section>
      ...
      <section className="border-b border-hairline bg-warm">
        <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 md:py-20">
          <RevealOnScroll>
            ...
            <div className="mt-6 space-y-5 text-lg leading-relaxed text-ink-dim">
              <p>
                Junior football and netball have their own rhythms. Quarters,
                not halves. Position areas the kids actually recognise —
                attack/centre/back for football, three thirds with seven bibs
                for netball. The &ldquo;everyone gets a go&rdquo; ethos.
                Fixtures via PlayHQ. Lending a kid to the opposition when
                numbers are uneven. Mid-quarter subs when your league allows
                them, period-break subs when it doesn&apos;t. Siren is shaped
            ...
            <div className="rounded-lg border border-hairline bg-surface p-6 shadow-card sm:p-8">
              ...
              <div className="mt-4 space-y-4 text-base leading-relaxed text-ink-dim">
                <p>
                  ...
                  the sideline and couldn&apos;t find a tool built properly for
                  our game. I&apos;m a parent-coach in Australia, not a SaaS
                  company.
                </p>
                <p>
                  Siren is free for the entire 2026 season. No trial timer, no
                  paywall, no upsell. I&apos;m using this season to learn from
                  the coaches using it and make it better week by week. Clubs
                  who get on board now will be looked after when paid options
                  arrive.
                </p>
                <p className="text-ink">
                  If you want to be the coach whose kids all remember getting a
                  go, I&apos;d love your help shaping it.
                </p>
              </div>
              <p className="mt-6 text-sm font-semibold text-ink">Steve Bull</p>
