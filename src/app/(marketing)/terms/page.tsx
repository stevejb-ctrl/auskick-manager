      ...
      <div className="mt-8 space-y-8 text-ink-dim">
        <section>
          <p className="text-base leading-relaxed">
            ...
            sirenfooty.com.au or sirennetball.com.au — you agree to these terms.
        ...
        <Section title="1. What Siren is">
          <p>
            ...
            football and netball teams: rotating players fairly, tracking
            availability, managing game-day subs, and keeping a simple record of
            each season. It is a tool for adults managing junior teams; it is
            not for use by children directly.
          </p>
        </Section>
        ...
        <Section title="3. Acceptable use">
          ...
          <ul>
            ...
            <li>
              Enter personal data about people (including children) without the
              authority to do so. For example, only add a player to a squad if
              you are the team coach, manager, or have equivalent consent from
              the club.
            </li>
            <li>
        ...
        <Section title="4. Content you add">
          <p>
            ...
            player names, game notes, team songs, etc.). By adding content, you
            grant us a limited licence to host, store, process, and display that
            content solely to run the app for you and your team.
          </p>
          <p>
        ...
        <Section title="5. Team roles and access">
          <p>
            ...
            someone to a team, they will see the team&rsquo;s squad, games, and
            related data according to the role you give them. Choose roles with
            care.
          </p>
          <p>
        ...
        <Section title="7. Price">
          <p>
            ...
            before any charges apply and you will always be able to continue at
            your current tier, downgrade, or cancel.
          </p>
        </Section>
        ...
        <Section title="9. Termination">
          <p>
            ...
            these terms, if required by law, or if we discontinue the app. If we
            discontinue the app, we&rsquo;ll try to give reasonable notice and a
            way to export your team data.
          </p>
        </Section>
        ...
        <Section title="10. Disclaimers">
          <p>
            ...
            app will be error-free, secure, or always available.
          </p>
          <p>
        ...
        <Section title="11. Limitation of liability">
          <p>
            To the maximum extent permitted by law, Siren is not liable for any
            indirect, incidental, special, consequential, or punitive damages,
            or any loss of profits, revenue, data, or goodwill, arising out of
            your use of the app. Our total liability to you for any claim
            arising out of or relating to these terms or the app is limited to
            AUD $100.
          </p>
        </Section>
        ...
        <Section title="12. Changes to these terms">
          <p>
            ...
            changes, we&rsquo;ll update the &ldquo;Last updated&rdquo; date and,
            where appropriate, notify you by email or through the app.
            Continuing to use Siren after changes take effect means you accept
            the updated terms.
          </p>
        </Section>
