  ...
  return (
    <SportThemeProvider sport="footy">
      <div className="min-h-screen">
        ...
        <div className="mx-auto max-w-5xl px-4 py-8">
          <div className="md:flex md:gap-10">
            <aside className="mb-6 md:mb-0 md:w-48 md:shrink-0">
              <p className="mb-3 font-mono text-[10px] font-bold uppercase tracking-banner text-ink-mute">
                Help
              </p>
              <HelpNav />
            </aside>
        ...
        <footer className="mt-12 border-t border-hairline py-6 text-center font-mono text-[11px] uppercase tracking-banner text-ink-mute">
          <SirenWordmark size="sm" className="mr-3 align-middle" />
